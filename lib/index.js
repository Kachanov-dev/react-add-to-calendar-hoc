  ...
  return (
        ...
        _createClass(AddToCalendarWrapped, [
          {
            ...
            value: function render() {
              ...
              const isDropdownOpen = dropdownProps.isOpen;
              ...
              return _react.default.createElement(
                ...
                (this.state.dropdownOpen || isDropdownOpen) &&
                  _react.default.createElement(
                    WrappedDropdown,
                    _extends({}, dropdownProps, {
                      isOpen: this.state.dropdownOpen || isDropdownOpen,
    ...
    _defineProperty(_class, "propTypes", {
      ...
      event: _propTypes.default.shape({
        ...
        descriptionGoogle: _propTypes.default.string,
        descriptionIcal: _propTypes.default.string,
      }).isRequired,
      filename: _propTypes.default.string,
      items: _propTypes.default.arrayOf(
        _propTypes.default.oneOf(
          Object.keys(_enums.SHARE_SITES).map(function (itm) {
