...
var googleShareUrl = function googleShareUrl(_ref) {
  ...
  return "https://calendar.google.com/calendar/render?action=TEMPLATE&dates=".concat(startDatetime, "/").concat(endDatetime).concat(timezone && "&ctz=".concat(timezone), "&location=").concat(location, "&text=").concat(title, "&details=").concat(description).concat(attendees);
};
/**
...
var shareFileParsAttendeesMail = function shareFileParsAttendeesMail(attendees){
  if(attendees.length === 0){ return ''}
  var str = "";
...
var buildShareUrl = function buildShareUrl(_ref4, type) {
  var _ref4$description = _ref4.description,
      ...
      descriptionIcal = _ref4$descriptionIcal === void 0 ? '' : _ref4$descriptionIcal,
      _ref4$descriptionGoogle = _ref4.descriptionGoogle,
      descriptionGoogle = _ref4$descriptionGoogle === void 0 ? '' : _ref4$descriptionGoogle,
